# Contributing to ClubLog HA Bridge

Thank you for your interest in contributing to ClubLog HA Bridge!
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/clublog-ha-bridge.git
...
# Run in debug mode
DEBUG_MODE=True python3 clublog-ha-bridge.py
```
...
- Test error handling (API failures, rate limiting, network issues)
...
- Ensure no sensitive data (IPs, passwords, API keys, callsigns) in commits

## Dual Architecture

This project supports two deployment methods:

1. **HACS Integration** (`custom_components/clublog/`): Native Home Assistant component
2. **Docker/MQTT Bridge** (`clublog-ha-bridge.py`): Standalone container
